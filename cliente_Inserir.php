...
$sql = $sql . "(nome,nascimento ,cpf,telefone,email,observacao) ";
$sql = $sql . "VALUES ('$nome','$nascimento' , '$cpf' , '$telefone' , '$email' ,  '$obs')";

$inserir = $conn->exec($sql);
?>
...
<html>
    ...
    <center>
        <a href="cliente_Cadastrar.php" role="button" class="btn btn-sm btn-primary">Cadastrar novo cliente</a>
