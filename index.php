...
<html lang="en">
    ...
    <body>
        ...
        <!-- Definindo as variaveis da interface com css -->
        <style type="text/css">
            #tamanhoContainer {
                width: 900px;
            }
                            ...
                            <div class="card w-90">
                                <div class="card-body">
                                    ...
                                    <div class="botao" id="botao">
                                        <a href="cliente_Cadastrar.php" class="btn btn-outline-primary button">Cadastrar</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card text-center">
                            <div class="card w-90">
                                <div class="card-body">
                                    ...
                                    <div class="botao" id="botao">
                                        <a href="cliente_Listar.php" class="btn btn-outline-primary button">Listar</a>
                                    </div>
                                </div>    
                            </div>
                        </div>
